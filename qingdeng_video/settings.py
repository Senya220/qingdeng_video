"""
Django settings for qingdeng_video project.
...
SECRET_KEY = '%($^29vf%0$p*tp_ne$21*p(oxhlcb2(jnc5dia=xun7w1ir(#'
...
ROOT_URLCONF = 'qingdeng_video.urls'
...
WSGI_APPLICATION = 'qingdeng_video.wsgi.application'
